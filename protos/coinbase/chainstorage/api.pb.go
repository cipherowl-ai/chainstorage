...
type BlockReadSource int32

const (
	BlockReadSource_BLOCK_READ_SOURCE_DEFAULT BlockReadSource = 0
	// Alias order controls the protojson spelling. Keep the pre-rename name first
	// until mixed-version REST clients and servers no longer coexist.
	BlockReadSource_BLOCK_READ_SOURCE_LEGACY       BlockReadSource = 1
	BlockReadSource_BLOCK_READ_SOURCE_SINGLE_BLOCK BlockReadSource = 1
	BlockReadSource_BLOCK_READ_SOURCE_CONSOLIDATED BlockReadSource = 2
)

// Enum value maps for BlockReadSource.
var (
	BlockReadSource_name = map[int32]string{
		0: "BLOCK_READ_SOURCE_DEFAULT",
		1: "BLOCK_READ_SOURCE_LEGACY",
		// Duplicate value: 1: "BLOCK_READ_SOURCE_SINGLE_BLOCK",
		2: "BLOCK_READ_SOURCE_CONSOLIDATED",
	}
	BlockReadSource_value = map[string]int32{
		"BLOCK_READ_SOURCE_DEFAULT":      0,
		"BLOCK_READ_SOURCE_LEGACY":       1,
		"BLOCK_READ_SOURCE_SINGLE_BLOCK": 1,
		"BLOCK_READ_SOURCE_CONSOLIDATED": 2,
	}
)

func (x BlockReadSource) Enum() *BlockReadSource {
	p := new(BlockReadSource)
	*p = x
	return p
}

func (x BlockReadSource) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (BlockReadSource) Descriptor() protoreflect.EnumDescriptor {
	return file_coinbase_chainstorage_api_proto_enumTypes[2].Descriptor()
}

func (BlockReadSource) Type() protoreflect.EnumType {
	return &file_coinbase_chainstorage_api_proto_enumTypes[2]
}

func (x BlockReadSource) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use BlockReadSource.Descriptor instead.
func (BlockReadSource) EnumDescriptor() ([]byte, []int) {
...
func (BlockchainEvent_Type) Descriptor() protoreflect.EnumDescriptor {
	return file_coinbase_chainstorage_api_proto_enumTypes[3].Descriptor()
}

func (BlockchainEvent_Type) Type() protoreflect.EnumType {
	return &file_coinbase_chainstorage_api_proto_enumTypes[3]
}
...
type BlockFile struct {
	...
	ByteOffset         uint64                 `protobuf:"varint,10,opt,name=byte_offset,json=byteOffset,proto3" json:"byte_offset,omitempty"`
	ByteLength         uint64                 `protobuf:"varint,11,opt,name=byte_length,json=byteLength,proto3" json:"byte_length,omitempty"`
	UncompressedLength uint64                 `protobuf:"varint,12,opt,name=uncompressed_length,json=uncompressedLength,proto3" json:"uncompressed_length,omitempty"`
	ObjectFormat       BlockObjectFormat      `protobuf:"varint,13,opt,name=object_format,json=objectFormat,proto3,enum=coinbase.chainstorage.BlockObjectFormat" json:"object_format,omitempty"`
}
...
func (x *BlockFile) GetByteOffset() uint64 {
	if x != nil {
		return x.ByteOffset
	}
	return 0
...
func (x *BlockFile) GetByteLength() uint64 {
	if x != nil {
		return x.ByteLength
	}
	return 0
...
func (x *BlockFile) GetUncompressedLength() uint64 {
	if x != nil {
...
func (x *BlockFile) GetObjectFormat() BlockObjectFormat {
	if x != nil {
		return x.ObjectFormat
	}
	return BlockObjectFormat_BLOCK_OBJECT_FORMAT_LEGACY_SINGLE_BLOCK
}
...
type GetBlockFileRequest struct {
	...
	ReadSource BlockReadSource `protobuf:"varint,4,opt,name=read_source,json=readSource,proto3,enum=coinbase.chainstorage.BlockReadSource" json:"read_source,omitempty"`
}
...
func (x *GetBlockFileRequest) GetReadSource() BlockReadSource {
	if x != nil {
		return x.ReadSource
	}
	return BlockReadSource_BLOCK_READ_SOURCE_DEFAULT
}
...
func (x *GetBlockFilesByRangeRequest) GetReadSource() BlockReadSource {
	if x != nil {
		return x.ReadSource
	}
	return BlockReadSource_BLOCK_READ_SOURCE_DEFAULT
...
func (x *GetRawBlockRequest) GetReadSource() BlockReadSource {
	if x != nil {
		return x.ReadSource
	}
	return BlockReadSource_BLOCK_READ_SOURCE_DEFAULT
...
func (x *GetRawBlocksByRangeRequest) GetReadSource() BlockReadSource {
	if x != nil {
		return x.ReadSource
	}
	return BlockReadSource_BLOCK_READ_SOURCE_DEFAULT
...
func (x *GetNativeBlockRequest) GetReadSource() BlockReadSource {
	if x != nil {
		return x.ReadSource
	}
	return BlockReadSource_BLOCK_READ_SOURCE_DEFAULT
...
func (x *GetNativeBlocksByRangeRequest) GetReadSource() BlockReadSource {
	if x != nil {
		return x.ReadSource
	}
	return BlockReadSource_BLOCK_READ_SOURCE_DEFAULT
...
func (x *GetRosettaBlockRequest) GetReadSource() BlockReadSource {
	if x != nil {
		return x.ReadSource
	}
	return BlockReadSource_BLOCK_READ_SOURCE_DEFAULT
...
func (x *GetRosettaBlocksByRangeRequest) GetReadSource() BlockReadSource {
	if x != nil {
		return x.ReadSource
	}
	return BlockReadSource_BLOCK_READ_SOURCE_DEFAULT
...
var file_coinbase_chainstorage_api_proto_rawDesc = []byte{
	...
	0x6f, 0x22, 0x91, 0x04, 0x0a, 0x09, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x46, 0x69, 0x6c, 0x65, 0x12,
	...
	,
	...
	,
	...
	0x20, 0x01, 0x28, 0x0d, 0x52, 0x03, 0x74, 0x61, 0x67, 0x12, 0x12, 0x0a, 0x04, 0x68, 0x61, 0x73,
	...
	0x22, 0x9c, 0x01, 0x0a, 0x13, 0x47, 0x65, 0x74, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x46, 0x69, 0x6c,
	0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x10, 0x0a, 0x03, 0x74, 0x61, 0x67, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x03, 0x74, 0x61, 0x67, 0x12, 0x16, 0x0a, 0x06, 0x68, 0x65,
	...
	,
	...
	,
	...
	0x09, 0x52, 0x04, 0x68, 0x61, 0x73, 0x68, 0x12, 0x47, 0x0a, 0x0b, 0x72, 0x65, 0x61, 0x64, 0x5f,
	0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x26, 0x2e, 0x63,
	0x6f, 0x69, 0x6e, 0x62, 0x61, 0x73, 0x65, 0x2e, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x73, 0x74, 0x6f,
	0x72, 0x61, 0x67, 0x65, 0x2e, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x52, 0x65, 0x61, 0x64, 0x53, 0x6f,
	0x75, 0x72, 0x63, 0x65, 0x52, 0x0a, 0x72, 0x65, 0x61, 0x64, 0x53, 0x6f, 0x75, 0x72, 0x63, 0x65,
	...
	0x65, 0x2e, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x73, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x2e, 0x42,
	0x6c, 0x6f, 0x63, 0x6b, 0x52, 0x05, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x22, 0xb9, 0x01, 0x0a, 0x1a,
	0x47, 0x65, 0x74, 0x52, 0x61, 0x77, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x73, 0x42, 0x79, 0x52, 0x61,
	0x6e, 0x67, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x10, 0x0a, 0x03, 0x74, 0x61,
	0x67, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x03, 0x74, 0x61, 0x67, 0x12, 0x21, 0x0a, 0x0c,
	...
	,
	...
	,
	...
	,
	...
	0x65, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x52, 0x06, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x73, 0x22, 0x9f,
	0x01, 0x0a, 0x16, 0x47, 0x65, 0x74, 0x52, 0x6f, 0x73, 0x65, 0x74, 0x74, 0x61, 0x42, 0x6c, 0x6f,
	0x63, 0x6b, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x10, 0x0a, 0x03, 0x74, 0x61, 0x67,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x03, 0x74, 0x61, 0x67, 0x12, 0x16, 0x0a, 0x06, 0x68,
	0x65, 0x69, 0x67, 0x68, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x04, 0x52, 0x06, 0x68, 0x65, 0x69,
	0x67, 0x68, 0x74, 0x12, 0x12, 0x0a, 0x04, 0x68, 0x61, 0x73, 0x68, 0x18, 0x03, 0x20, 0x01, 0x28,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x52, 0x05, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x22, 0x5b, 0x0a, 0x1c, 0x47, 0x65, 0x74, 0x42, 0x6c,
	0x6f, 0x63, 0x6b, 0x42, 0x79, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x10, 0x0a, 0x03, 0x74, 0x61, 0x67, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x0d, 0x52, 0x03, 0x74, 0x61, 0x67, 0x12, 0x29, 0x0a, 0x10, 0x74, 0x72, 0x61,
	...
	0x48, 0x61, 0x73, 0x68, 0x22, 0x5f, 0x0a, 0x1d, 0x47, 0x65, 0x74, 0x42, 0x6c, 0x6f, 0x63, 0x6b,
	...
	0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x26, 0x2e, 0x63, 0x6f, 0x69, 0x6e, 0x62, 0x61, 0x73, 0x65,
	0x2e, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x73, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x2e, 0x42, 0x6c,
	0x6f, 0x63, 0x6b, 0x49, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x66, 0x69, 0x65, 0x72, 0x52, 0x06, 0x62,
	0x6c, 0x6f, 0x63, 0x6b, 0x73, 0x22, 0x5a, 0x0a, 0x1b, 0x47, 0x65, 0x74, 0x4e, 0x61, 0x74, 0x69,
	...
	0x0d, 0x52, 0x03, 0x74, 0x61, 0x67, 0x12, 0x29, 0x0a, 0x10, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x61,
	...
	,
	...
	,
	...
	,
	...
	0x6f, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x88, 0x01, 0x0a, 0x17, 0x47,
	0x65, 0x74, 0x56, 0x65, 0x72, 0x69, 0x66, 0x69, 0x65, 0x64, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e,
	0x74, 0x53, 0x74, 0x61, 0x74, 0x65, 0x12, 0x35, 0x2e, 0x63, 0x6f, 0x69, 0x6e, 0x62, 0x61, 0x73,
	0x65, 0x2e, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x73, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x2e, 0x47,
	0x65, 0x74, 0x56, 0x65, 0x72, 0x69, 0x66, 0x69, 0x65, 0x64, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e,
	...
	0x64, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x53, 0x74, 0x61, 0x74, 0x65, 0x52, 0x65, 0x73,
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x7c, 0x0a, 0x13, 0x47, 0x65, 0x74, 0x42, 0x6c, 0x6f, 0x63,
	0x6b, 0x42, 0x79, 0x54, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x12, 0x31, 0x2e, 0x63,
	0x6f, 0x69, 0x6e, 0x62, 0x61, 0x73, 0x65, 0x2e, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x73, 0x74, 0x6f,
	0x72, 0x61, 0x67, 0x65, 0x2e, 0x47, 0x65, 0x74, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x42, 0x79, 0x54,
	0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a,
	0x32, 0x2e, 0x63, 0x6f, 0x69, 0x6e, 0x62, 0x61, 0x73, 0x65, 0x2e, 0x63, 0x68, 0x61, 0x69, 0x6e,
...
var file_coinbase_chainstorage_api_proto_enumTypes = make([]protoimpl.EnumInfo, 4)
...
var file_coinbase_chainstorage_api_proto_goTypes = []interface{}{
	...
	(BlockReadSource)(0),                           // 2: coinbase.chainstorage.BlockReadSource
	(BlockchainEvent_Type)(0),                      // 3: coinbase.chainstorage.BlockchainEvent.Type
	(*BlockFile)(nil),                              // 4: coinbase.chainstorage.BlockFile
	(*BlockchainEvent)(nil),                        // 5: coinbase.chainstorage.BlockchainEvent
	(*GetLatestBlockRequest)(nil),                  // 6: coinbase.chainstorage.GetLatestBlockRequest
	(*GetLatestBlockResponse)(nil),                 // 7: coinbase.chainstorage.GetLatestBlockResponse
	(*GetBlockFileRequest)(nil),                    // 8: coinbase.chainstorage.GetBlockFileRequest
	(*GetBlockFileResponse)(nil),                   // 9: coinbase.chainstorage.GetBlockFileResponse
	(*GetBlockFilesByRangeRequest)(nil),            // 10: coinbase.chainstorage.GetBlockFilesByRangeRequest
	(*GetBlockFilesByRangeResponse)(nil),           // 11: coinbase.chainstorage.GetBlockFilesByRangeResponse
	(*GetRawBlockRequest)(nil),                     // 12: coinbase.chainstorage.GetRawBlockRequest
	(*GetRawBlockResponse)(nil),                    // 13: coinbase.chainstorage.GetRawBlockResponse
	(*GetRawBlocksByRangeRequest)(nil),             // 14: coinbase.chainstorage.GetRawBlocksByRangeRequest
	(*GetRawBlocksByRangeResponse)(nil),            // 15: coinbase.chainstorage.GetRawBlocksByRangeResponse
	(*GetNativeBlockRequest)(nil),                  // 16: coinbase.chainstorage.GetNativeBlockRequest
	(*GetNativeBlockResponse)(nil),                 // 17: coinbase.chainstorage.GetNativeBlockResponse
	(*GetNativeBlocksByRangeRequest)(nil),          // 18: coinbase.chainstorage.GetNativeBlocksByRangeRequest
	(*GetNativeBlocksByRangeResponse)(nil),         // 19: coinbase.chainstorage.GetNativeBlocksByRangeResponse
	(*GetRosettaBlockRequest)(nil),                 // 20: coinbase.chainstorage.GetRosettaBlockRequest
	(*GetRosettaBlockResponse)(nil),                // 21: coinbase.chainstorage.GetRosettaBlockResponse
	(*GetRosettaBlocksByRangeRequest)(nil),         // 22: coinbase.chainstorage.GetRosettaBlocksByRangeRequest
	(*GetRosettaBlocksByRangeResponse)(nil),        // 23: coinbase.chainstorage.GetRosettaBlocksByRangeResponse
	(*ChainEventsRequest)(nil),                     // 24: coinbase.chainstorage.ChainEventsRequest
	(*ChainEventsResponse)(nil),                    // 25: coinbase.chainstorage.ChainEventsResponse
	(*GetChainEventsRequest)(nil),                  // 26: coinbase.chainstorage.GetChainEventsRequest
	(*GetChainEventsResponse)(nil),                 // 27: coinbase.chainstorage.GetChainEventsResponse
	(*GetChainMetadataRequest)(nil),                // 28: coinbase.chainstorage.GetChainMetadataRequest
	(*GetChainMetadataResponse)(nil),               // 29: coinbase.chainstorage.GetChainMetadataResponse
	(*GetVersionedChainEventRequest)(nil),          // 30: coinbase.chainstorage.GetVersionedChainEventRequest
	(*GetVersionedChainEventResponse)(nil),         // 31: coinbase.chainstorage.GetVersionedChainEventResponse
	(*GetBlockByTransactionRequest)(nil),           // 32: coinbase.chainstorage.GetBlockByTransactionRequest
	(*GetBlockByTransactionResponse)(nil),          // 33: coinbase.chainstorage.GetBlockByTransactionResponse
	(*GetNativeTransactionRequest)(nil),            // 34: coinbase.chainstorage.GetNativeTransactionRequest
	(*GetNativeTransactionResponse)(nil),           // 35: coinbase.chainstorage.GetNativeTransactionResponse
	(*GetVerifiedAccountStateRequest)(nil),         // 36: coinbase.chainstorage.GetVerifiedAccountStateRequest
	(*GetVerifiedAccountStateResponse)(nil),        // 37: coinbase.chainstorage.GetVerifiedAccountStateResponse
	(*GetBlockByTimestampRequest)(nil),             // 38: coinbase.chainstorage.GetBlockByTimestampRequest
	(*GetBlockByTimestampResponse)(nil),            // 39: coinbase.chainstorage.GetBlockByTimestampResponse
	(*timestamppb.Timestamp)(nil),                  // 40: google.protobuf.Timestamp
	(BlockObjectFormat)(0),                         // 41: coinbase.chainstorage.BlockObjectFormat
	(*BlockIdentifier)(nil),                        // 42: coinbase.chainstorage.BlockIdentifier
	(*Block)(nil),                                  // 43: coinbase.chainstorage.Block
	(*NativeBlock)(nil),                            // 44: coinbase.chainstorage.NativeBlock
	(*RosettaBlock)(nil),                           // 45: coinbase.chainstorage.RosettaBlock
	(*NativeTransaction)(nil),                      // 46: coinbase.chainstorage.NativeTransaction
	(*InternalGetVerifiedAccountStateRequest)(nil), // 47: coinbase.chainstorage.InternalGetVerifiedAccountStateRequest
	(*ValidateAccountStateResponse)(nil),           // 48: coinbase.chainstorage.ValidateAccountStateResponse
}
var file_coinbase_chainstorage_api_proto_depIdxs = []int32{
	...
	40, // 1: coinbase.chainstorage.BlockFile.block_timestamp:type_name -> google.protobuf.Timestamp
	41, // 2: coinbase.chainstorage.BlockFile.object_format:type_name -> coinbase.chainstorage.BlockObjectFormat
	3,  // 3: coinbase.chainstorage.BlockchainEvent.type:type_name -> coinbase.chainstorage.BlockchainEvent.Type
	42, // 4: coinbase.chainstorage.BlockchainEvent.block:type_name -> coinbase.chainstorage.BlockIdentifier
	40, // 5: coinbase.chainstorage.GetLatestBlockResponse.timestamp:type_name -> google.protobuf.Timestamp
	2,  // 6: coinbase.chainstorage.GetBlockFileRequest.read_source:type_name -> coinbase.chainstorage.BlockReadSource
	4,  // 7: coinbase.chainstorage.GetBlockFileResponse.file:type_name -> coinbase.chainstorage.BlockFile
	2,  // 8: coinbase.chainstorage.GetBlockFilesByRangeRequest.read_source:type_name -> coinbase.chainstorage.BlockReadSource
	4,  // 9: coinbase.chainstorage.GetBlockFilesByRangeResponse.files:type_name -> coinbase.chainstorage.BlockFile
	2,  // 10: coinbase.chainstorage.GetRawBlockRequest.read_source:type_name -> coinbase.chainstorage.BlockReadSource
	43, // 11: coinbase.chainstorage.GetRawBlockResponse.block:type_name -> coinbase.chainstorage.Block
	2,  // 12: coinbase.chainstorage.GetRawBlocksByRangeRequest.read_source:type_name -> coinbase.chainstorage.BlockReadSource
	43, // 13: coinbase.chainstorage.GetRawBlocksByRangeResponse.blocks:type_name -> coinbase.chainstorage.Block
	2,  // 14: coinbase.chainstorage.GetNativeBlockRequest.read_source:type_name -> coinbase.chainstorage.BlockReadSource
	44, // 15: coinbase.chainstorage.GetNativeBlockResponse.block:type_name -> coinbase.chainstorage.NativeBlock
	2,  // 16: coinbase.chainstorage.GetNativeBlocksByRangeRequest.read_source:type_name -> coinbase.chainstorage.BlockReadSource
	44, // 17: coinbase.chainstorage.GetNativeBlocksByRangeResponse.blocks:type_name -> coinbase.chainstorage.NativeBlock
	2,  // 18: coinbase.chainstorage.GetRosettaBlockRequest.read_source:type_name -> coinbase.chainstorage.BlockReadSource
	45, // 19: coinbase.chainstorage.GetRosettaBlockResponse.block:type_name -> coinbase.chainstorage.RosettaBlock
	2,  // 20: coinbase.chainstorage.GetRosettaBlocksByRangeRequest.read_source:type_name -> coinbase.chainstorage.BlockReadSource
	45, // 21: coinbase.chainstorage.GetRosettaBlocksByRangeResponse.blocks:type_name -> coinbase.chainstorage.RosettaBlock
	5,  // 22: coinbase.chainstorage.ChainEventsResponse.event:type_name -> coinbase.chainstorage.BlockchainEvent
	5,  // 23: coinbase.chainstorage.GetChainEventsResponse.events:type_name -> coinbase.chainstorage.BlockchainEvent
	5,  // 24: coinbase.chainstorage.GetVersionedChainEventResponse.event:type_name -> coinbase.chainstorage.BlockchainEvent
	42, // 25: coinbase.chainstorage.GetBlockByTransactionResponse.blocks:type_name -> coinbase.chainstorage.BlockIdentifier
	46, // 26: coinbase.chainstorage.GetNativeTransactionResponse.transactions:type_name -> coinbase.chainstorage.NativeTransaction
	47, // 27: coinbase.chainstorage.GetVerifiedAccountStateRequest.req:type_name -> coinbase.chainstorage.InternalGetVerifiedAccountStateRequest
	48, // 28: coinbase.chainstorage.GetVerifiedAccountStateResponse.response:type_name -> coinbase.chainstorage.ValidateAccountStateResponse
	6,  // 29: coinbase.chainstorage.ChainStorage.GetLatestBlock:input_type -> coinbase.chainstorage.GetLatestBlockRequest
	8,  // 30: coinbase.chainstorage.ChainStorage.GetBlockFile:input_type -> coinbase.chainstorage.GetBlockFileRequest
	10, // 31: coinbase.chainstorage.ChainStorage.GetBlockFilesByRange:input_type -> coinbase.chainstorage.GetBlockFilesByRangeRequest
	12, // 32: coinbase.chainstorage.ChainStorage.GetRawBlock:input_type -> coinbase.chainstorage.GetRawBlockRequest
	14, // 33: coinbase.chainstorage.ChainStorage.GetRawBlocksByRange:input_type -> coinbase.chainstorage.GetRawBlocksByRangeRequest
	16, // 34: coinbase.chainstorage.ChainStorage.GetNativeBlock:input_type -> coinbase.chainstorage.GetNativeBlockRequest
	18, // 35: coinbase.chainstorage.ChainStorage.GetNativeBlocksByRange:input_type -> coinbase.chainstorage.GetNativeBlocksByRangeRequest
	20, // 36: coinbase.chainstorage.ChainStorage.GetRosettaBlock:input_type -> coinbase.chainstorage.GetRosettaBlockRequest
	22, // 37: coinbase.chainstorage.ChainStorage.GetRosettaBlocksByRange:input_type -> coinbase.chainstorage.GetRosettaBlocksByRangeRequest
	24, // 38: coinbase.chainstorage.ChainStorage.StreamChainEvents:input_type -> coinbase.chainstorage.ChainEventsRequest
	26, // 39: coinbase.chainstorage.ChainStorage.GetChainEvents:input_type -> coinbase.chainstorage.GetChainEventsRequest
	28, // 40: coinbase.chainstorage.ChainStorage.GetChainMetadata:input_type -> coinbase.chainstorage.GetChainMetadataRequest
	30, // 41: coinbase.chainstorage.ChainStorage.GetVersionedChainEvent:input_type -> coinbase.chainstorage.GetVersionedChainEventRequest
	32, // 42: coinbase.chainstorage.ChainStorage.GetBlockByTransaction:input_type -> coinbase.chainstorage.GetBlockByTransactionRequest
	34, // 43: coinbase.chainstorage.ChainStorage.GetNativeTransaction:input_type -> coinbase.chainstorage.GetNativeTransactionRequest
	36, // 44: coinbase.chainstorage.ChainStorage.GetVerifiedAccountState:input_type -> coinbase.chainstorage.GetVerifiedAccountStateRequest
	38, // 45: coinbase.chainstorage.ChainStorage.GetBlockByTimestamp:input_type -> coinbase.chainstorage.GetBlockByTimestampRequest
	7,  // 46: coinbase.chainstorage.ChainStorage.GetLatestBlock:output_type -> coinbase.chainstorage.GetLatestBlockResponse
	9,  // 47: coinbase.chainstorage.ChainStorage.GetBlockFile:output_type -> coinbase.chainstorage.GetBlockFileResponse
	11, // 48: coinbase.chainstorage.ChainStorage.GetBlockFilesByRange:output_type -> coinbase.chainstorage.GetBlockFilesByRangeResponse
	13, // 49: coinbase.chainstorage.ChainStorage.GetRawBlock:output_type -> coinbase.chainstorage.GetRawBlockResponse
	15, // 50: coinbase.chainstorage.ChainStorage.GetRawBlocksByRange:output_type -> coinbase.chainstorage.GetRawBlocksByRangeResponse
	17, // 51: coinbase.chainstorage.ChainStorage.GetNativeBlock:output_type -> coinbase.chainstorage.GetNativeBlockResponse
	19, // 52: coinbase.chainstorage.ChainStorage.GetNativeBlocksByRange:output_type -> coinbase.chainstorage.GetNativeBlocksByRangeResponse
	21, // 53: coinbase.chainstorage.ChainStorage.GetRosettaBlock:output_type -> coinbase.chainstorage.GetRosettaBlockResponse
	23, // 54: coinbase.chainstorage.ChainStorage.GetRosettaBlocksByRange:output_type -> coinbase.chainstorage.GetRosettaBlocksByRangeResponse
	25, // 55: coinbase.chainstorage.ChainStorage.StreamChainEvents:output_type -> coinbase.chainstorage.ChainEventsResponse
	27, // 56: coinbase.chainstorage.ChainStorage.GetChainEvents:output_type -> coinbase.chainstorage.GetChainEventsResponse
	29, // 57: coinbase.chainstorage.ChainStorage.GetChainMetadata:output_type -> coinbase.chainstorage.GetChainMetadataResponse
	31, // 58: coinbase.chainstorage.ChainStorage.GetVersionedChainEvent:output_type -> coinbase.chainstorage.GetVersionedChainEventResponse
	33, // 59: coinbase.chainstorage.ChainStorage.GetBlockByTransaction:output_type -> coinbase.chainstorage.GetBlockByTransactionResponse
	35, // 60: coinbase.chainstorage.ChainStorage.GetNativeTransaction:output_type -> coinbase.chainstorage.GetNativeTransactionResponse
	37, // 61: coinbase.chainstorage.ChainStorage.GetVerifiedAccountState:output_type -> coinbase.chainstorage.GetVerifiedAccountStateResponse
	39, // 62: coinbase.chainstorage.ChainStorage.GetBlockByTimestamp:output_type -> coinbase.chainstorage.GetBlockByTimestampResponse
