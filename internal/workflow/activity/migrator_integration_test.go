...
func (s *migratorIntegrationTestSuite) TestMigrateExtractedBlocks_NoReorg_ValidationPasses() {
	...
	blocks := []BlockToMigrate{
		{Height: 100, Hash: "0x100", ParentHash: "0x99", EventSeq: 1},
		{Height: 101, Hash: "0x101", ParentHash: "0x100", EventSeq: 2},
		{Height: 102, Hash: "0x102", ParentHash: "0x101", EventSeq: 3},
	}
	...
	// Execute
	count, err := migrator.migrateExtractedBlocks(ctx, s.logger, data, request, blocks, events)
...
func (s *migratorIntegrationTestSuite) TestMigrateExtractedBlocks_SingleReorg_CorrectParentValidation() {
	...
	blocks := []BlockToMigrate{
		{Height: 100, Hash: "0x100", ParentHash: "0x99", EventSeq: 1},
		{Height: 101, Hash: "0x101", ParentHash: "0x100", EventSeq: 2},
		{Height: 102, Hash: "0x102a", ParentHash: "0x101", EventSeq: 3},
		{Height: 102, Hash: "0x102b", ParentHash: "0x101", EventSeq: 5},
		{Height: 103, Hash: "0x103", ParentHash: "0x102b", EventSeq: 6},
	}
...
func (s *migratorIntegrationTestSuite) TestMigrateExtractedBlocks_ValidationFailure() {
	...
	blocks := []BlockToMigrate{
		{Height: 100, Hash: "0x100", ParentHash: "0x99", EventSeq: 1},
		{Height: 101, Hash: "0x101", ParentHash: "0xWRONG", EventSeq: 2}, // Wrong parent
	}
...
func (s *migratorIntegrationTestSuite) TestMigrateExtractedBlocks_ComplexReorg_MultipleSegments() {
	...
	blocks := []BlockToMigrate{
		...
		{Height: 101, Hash: "0x101b", EventSeq: 4},
		{Height: 102, Hash: "0x102a", EventSeq: 5},
		{Height: 101, Hash: "0x101c", EventSeq: 8},
...
func (s *migratorIntegrationTestSuite) TestMigrateExtractedBlocks_SkippedBlocks() {
	...
	blocks := []BlockToMigrate{
		{Height: 100, Hash: "0x100", EventSeq: 1, Skipped: false},
		{Height: 101, Hash: "", EventSeq: 2, Skipped: true}, // Skipped block
		{Height: 102, Hash: "0x102", EventSeq: 3, Skipped: false},
	}
...
func (s *migratorIntegrationTestSuite) TestMigrateExtractedBlocks_ParentNotFound_ContinuesWithoutValidation() {
	...
	blocks := []BlockToMigrate{
		{Height: 0, Hash: "0x0", ParentHash: "", EventSeq: 1},
		{Height: 1, Hash: "0x1", ParentHash: "0x0", EventSeq: 2},
	}
